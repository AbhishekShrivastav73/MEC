    ...
    <article class="mec-single-event mec-single-modern mec-single-modal">
        ...
        <div class="col-md-4">
            ...
            <div class="mec-event-meta mec-color-before mec-frontbox <?php echo ((!$this->main->can_show_booking_module($event, true) and in_array($organizer_id, array('0', '1')) and !$more_info) ? 'mec-util-hidden' : ''); ?>">
                ...
                <?php elseif($event_link and !$this->main->is_expired($event)): ?>
                    <a class="mec-booking-button mec-bg-color" target="_blank" rel="noopener noreferrer" href="<?php echo esc_url($event_link); ?>"><?php echo esc_html($this->main->m('register_button', esc_html__('REGISTER', 'modern-events-calendar-lite'))); ?></a>
        ...
        <div class="col-md-8">
            ...
            <div class="mec-events-meta-group mec-events-meta-group-gmap">
                <?php echo MEC_kses::full($this->main->module('googlemap.details', array('event' => $this->events, 'auto_init'=>false, 'uniqueid' => $this->uniqueid, 'icons' => $this->icons))); ?>
            </div>
            ...
            <div id="mec-events-meta-group-booking-<?php echo esc_attr($this->uniqueid); ?>" class="mec-events-meta-group mec-events-meta-group-booking">
                ...
                if(isset($settings['booking_user_login']) and $settings['booking_user_login'] == '1' and !is_user_logged_in() ) {
                    ...
                    echo MEC_kses::full($this->main->module('booking.default', array('event' => $this->events, 'uniqueid' => $this->uniqueid, 'icons' => $this->icons)));
                }
                ?>
            </div>
            <?php endif ?>
...
jQuery("#mec_skin_<?php echo esc_attr($this->uniqueid); ?> .mec-speaker-avatar-dialog a").on('click', function(e)
{
    e.preventDefault();
