...
<div class="wns-be-container wns-be-container-sticky">
    <div id="wns-be-infobar">
        <div class="mec-search-settings-wrap">
            ...
            <input id="mec-search-settings" type="text" title="" placeholder="<?php esc_html_e('Search...', 'modern-events-calendar-lite'); ?>">
        </div>
                ...
                <div class="mec-container">
                    ...
                    <form id="mec_booking_form">
                        ...
                        <div id="booking_option" class="mec-options-fields active">
                            ...
                            <div id="mec_booking_container_toggle" class="<?php if((isset($settings['booking_status']) and !$settings['booking_status']) or !isset($settings['booking_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-basvanced-basic">
                                    ...
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            <select id="mec_settings_booking_date_selection" name="mec[settings][booking_date_selection]">
                                                <option value="dropdown" <?php echo ((!isset($settings['booking_date_selection']) || $settings['booking_date_selection'] == 'dropdown') ? 'selected' : ''); ?>><?php esc_html_e('Dropdown', 'modern-events-calendar-lite'); ?></option>
                                                <option value="calendar" <?php echo ((isset($settings['booking_date_selection']) && $settings['booking_date_selection'] == 'calendar') ? 'selected' : ''); ?>><?php esc_html_e('Calendar', 'modern-events-calendar-lite'); ?></option>
                                                <option value="checkboxes" <?php echo ((isset($settings['booking_date_selection']) && $settings['booking_date_selection'] == 'checkboxes') ? 'selected' : ''); ?>><?php esc_html_e('Checkboxes', 'modern-events-calendar-lite'); ?></option>
                                                <option value="express-calendar" <?php echo ((isset($settings['booking_date_selection']) && $settings['booking_date_selection'] == 'express-calendar') ? 'selected' : ''); ?>><?php esc_html_e('Express Calendar', 'modern-events-calendar-lite'); ?></option>
                                            </select>
                                            <span class="mec-tooltip">
                                            <div class="box left">
                                    ...
                                    <div class="mec-form-row">
                                        <label class="mec-col-3" for="mec_settings_booking_omit_end_date"><?php esc_html_e('Omit End Date', 'modern-events-calendar-lite'); ?></label>
                                        <div class="mec-col-9">
                                            <select id="mec_settings_booking_omit_end_date" name="mec[settings][booking_omit_end_date]">
                                                <option value="0" <?php echo ((!isset($settings['booking_omit_end_date']) || $settings['booking_omit_end_date'] === '0') ? 'selected' : ''); ?>><?php esc_html_e('No', 'modern-events-calendar-lite'); ?></option>
                                                <option value="1" <?php echo ((isset($settings['booking_omit_end_date']) && $settings['booking_omit_end_date'] === '1') ? 'selected' : ''); ?>><?php esc_html_e('If Possible', 'modern-events-calendar-lite'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            <select id="mec_settings_booking_date_selection_per_event" name="mec[settings][booking_date_selection_per_event]">
                                                <option value="0" <?php echo (!isset($settings['booking_date_selection_per_event']) || $settings['booking_date_selection_per_event'] == 0) ? 'selected' : ''; ?>><?php esc_html_e('No', 'modern-events-calendar-lite'); ?></option>
                                                <option value="1" <?php echo (isset($settings['booking_date_selection_per_event']) && $settings['booking_date_selection_per_event'] == 1) ? 'selected' : ''; ?>><?php esc_html_e('Yes', 'modern-events-calendar-lite'); ?></option>
                                            </select>
                                            <span class="mec-tooltip">
                                            <div class="box left">
                                ...
                                <div class="mec-basvanced-advanced w-hidden">
                                    <h5 class="title"><?php esc_html_e('General', 'modern-events-calendar-lite'); ?></h5>
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <label for="mec_settings_booking_start_from_first_upcoming_date">
                                                ...
                                                <?php esc_html_e('Start the dates in booking module from first upcoming date instead of referred date', 'modern-events-calendar-lite'); ?>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <label for="mec_settings_booking_unique_emails">
                                                ...
                                                <?php esc_html_e('Do not accept duplicate emails in the attendees form', 'modern-events-calendar-lite'); ?>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mec-form-row">
                                            <div class="mec-col-12">
                                                <label>
                                                    ...
                                                    <input id="mec_booking_payable_both" value="1" type="checkbox" name="mec[settings][booking_payable_both]" <?php if(isset($settings['booking_payable_both']) && $settings['booking_payable_both']) echo 'checked="checked"'; ?> /><?php esc_html_e('Offer flexible payment options', 'modern-events-calendar-lite'); ?>
                                                </label>
                                                <p><?php esc_html_e('Enable this option to offer customers the flexibility to choose between full and partial payments when booking.', 'modern-events-calendar-lite'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="booking_elements" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php esc_html_e('Booking Elements', 'modern-events-calendar-lite'); ?></h4>
                            <div class="mec-form-row">
                                <div class="mec-col-12">
                        ...
                        <div id="booking_tickets_option" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php esc_html_e('Global Tickets', 'modern-events-calendar-lite'); ?></h4>
                            <div class="mec-form-row">
                        ...
                        <div id="taxes_option" class="mec-options-fields">
                            ...
                            <div id="mec_taxes_fees_container_toggle" class="<?php if((isset($settings['taxes_fees_status']) and !$settings['taxes_fees_status']) or !isset($settings['taxes_fees_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <h5><?php echo esc_html__('Disable Fees per Gateways', 'modern-events-calendar-lite'); ?></h5>
                                ...
                                <div class="mec-form-row">
                                    <h5><?php echo esc_html__('Tax Method', 'modern-events-calendar-lite'); ?></h5>
                                    <div class="mec-col-12">
                                        <select id="mec_gateways_wc_autoorder_complete" name="mec[settings][tax_inclusion]">
                                            <option value="excluded" <?php echo((isset($settings['tax_inclusion']) && $settings['tax_inclusion'] === 'excluded') ? 'selected="selected"' : ''); ?>><?php esc_html_e('Tax Excluded', 'modern-events-calendar-lite'); ?></option>
                                            <option value="included" <?php echo((isset($settings['tax_inclusion']) && $settings['tax_inclusion'] === 'included') ? 'selected="selected"' : ''); ?>><?php esc_html_e('Tax Included', 'modern-events-calendar-lite'); ?></option>
                                        </select>
                                        <p><?php esc_attr_e("In most cases, the tax is exclusive. You can select inclusive, if you're inserting the price of tickets, tax included.", 'modern-events-calendar-lite'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                        ...
                        <div id="ticket_variations_option" class="mec-options-fields">
                            ...
                            <?php else: ?>
                                ...
                                <div id="mec_ticket_variations_container_toggle" class="<?php if((isset($settings['ticket_variations_status']) and !$settings['ticket_variations_status']) or !isset($settings['ticket_variations_status'])) echo 'mec-util-hidden'; ?>">
                                    ...
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <h5><?php esc_html_e('Ticket Variations Shortcode', 'modern-events-calendar-lite'); ?></h5>
                                            <p><?php echo sprintf(esc_html__('If you need to display ticket variations of an event outside the booking module you can use %s shortcode where the number 10 is the event id.', 'modern-events-calendar-lite'), '<code>[mec-ticket-variations event-id="10"]</code>'); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
