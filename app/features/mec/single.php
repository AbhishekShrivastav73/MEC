                ...
                <div class="mec-container">
                    ...
                    <form id="mec_single_form">
                        ...
                        <div id="event_options" class="mec-options-fields active">
                            ...
                            <div class="mec-basvanced-advanced w-hidden">
                                    ...
                                    <div class="mec-col-9">
                                        ...
                                        <span class="mec-tooltip">
                                            <div class="box left">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("Enabling this option will display the breadcrumbs on the single event page", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/single-event-settings/#3-_Breadcrumbs/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                    </div>
                                ...
                                <div id="mec_settings_breadcrumb_options" class="<?php echo isset($settings['breadcrumbs']) && $settings['breadcrumbs'] ? '' : 'mec-util-hidden'; ?>">
                                    <div class="mec-form-row">
                                        <label class="mec-col-3" for="mec_settings_breadcrumbs_archive_page"><?php esc_html_e('Breadcrumbs Events Page', 'modern-events-calendar-lite'); ?></label>
                                        <div class="mec-col-9">
                                            <select id="mec_settings_breadcrumbs_archive_page" name="mec[settings][breadcrumbs_events_page]">
                                                <option value=""><?php esc_html_e('Archive Page', 'modern-events-calendar-lite'); ?></option>
                                    ...
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            <label>
                                                ...
                                                <input type="checkbox" name="mec[settings][breadcrumbs_category]" id="mec_settings_breadcrumbs_category" <?php echo !isset($settings['breadcrumbs_category']) || $settings['breadcrumbs_category'] ? 'checked="checked"' : ''; ?> value="1" /><?php esc_html_e('Include Category in Breadcrumbs', 'modern-events-calendar-lite'); ?>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mec-form-row">
                                        <label>
                                            ...
                                            <input onchange="jQuery('#mec_event_banner_container').toggle();" value="1" type="checkbox" name="mec[settings][banner_status]" <?php if(isset($settings['banner_status']) and $settings['banner_status']) echo 'checked="checked"'; ?> /><?php esc_html_e('Enable Event Banner Feature', 'modern-events-calendar-lite'); ?>
                                        </label>
                                    </div>
                                ...
                                <div>
                                    <h5 class="mec-form-subtitle"><?php esc_html_e('Hourly Schedule Shortcode', 'modern-events-calendar-lite'); ?></h5>
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <p><?php echo sprintf(esc_html__("hourly schedule is available in the event details page but if you like to embed this module into a custom WP page or post or any shortcode compatible widgets, all you need to do is to insert %s shortcode into the page content and place the event id instead of 1.", 'modern-events-calendar-lite'), '<code>[mec-hourly-schedule event-id="1"]</code>'); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="single_icons_options" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php esc_html_e('Icons options', 'modern-events-calendar-lite'); ?></h4>
