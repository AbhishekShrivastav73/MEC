...
class FormBuilder extends Singleton {
    ...
    public static function submit_button( $post, $atts = array() )
    {
        ...
        ?>
        <button class="mec-fes-sub-button <?php echo $status ? 'g-recaptcha' : ''; ?>" type="submit" <?php echo $status ? $recaptcha->attributes() : ''; ?>><?php esc_html_e('Submit Event', 'modern-events-calendar-lite'); ?></button>
        <div class="mec-util-hidden">
