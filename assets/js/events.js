        ...
        if(newLabel != ''){
            $.ajax({
                ...
                success: function(response) {
                    if(response.success){
                        // Add new label to the meta box
                        $('#new_label').val('');
                        $('#new_label_color').val('');
                        $('#mec_custom_labels_meta_box').append('<label><input type="checkbox" name="mec_labels[]" value="'+response.data.id+'" checked>'+response.data.name+'</label>');
                        $('#mec_custom_labels_meta_box').append('<span class="mec-color" style="background-color: '+response.data.color+'"></span><br>');
                    } else {
