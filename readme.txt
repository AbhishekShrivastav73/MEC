...
= v 7.14.1 – 8 September 2024 =
- Fixed: An issue in RESTful API.

= 7.14.0 – 31 August 2024 =
...
= 7.12.1 – 17 July 2024 =
- Fixed: Content, organizer and cost widget in Elementor Single Builder addon
- Fixed: Some minor issues

= 7.12.0 – 6 July 2024 =
- Added: Booking reschedule notification to the move booking form
- Added: Option to not accept the duplicate emails in booking module
- Added: Option to change events page in breadcrumbs
- Added: Display of sold / all tickets in the backend event manager
- Improved: The events import from TEC
- Improved: The global tickets
- Fixed: Issue in search module regarding tag field
- Fixed: Date & time issue in general calendar
- Fixed: Some security issues
- Fixed: Auto scroll issue in booking module
- Fixed: Couple of issues regarding Subscribe + to Calendar feature
- Fixed: Some PHP notices
- Fixed: Issue in booking export feature
- Fixed: Issue in number of events in general calendar
- Fixed: Issue in maximum dates of booking module
- Fixed: Content issue in tooltip of monthly skin

= 7.11.0 – 9 June 2024 =
- Added: Mass email feature to suggest new events to previous bookers
- Added: Option to move bookings and notify the bookers while canceling a certain occurrence of event
- Improved: The event data feature
- Improved: The Frontend Event Submission by making the event pending for review after each update
- Fixed: Issue in monthly skin
- Fixed: Issue in autoplay feature of carousel skin in mobile devices
- Fixed: Issue in family tickets
...
= 7.2.2 – 20 October 2023 =
- Fixed: Issue in displaying bookings in admin

= 7.2.0 – 14 October 2023 =
- Added: Certificate builder feature
- Added: Attendees information to the admin calendar view
- Added: Option to rerun the database installation
- Added: Ability to cancel (and refund) all bookings of a certain occurrence while marking that occurrence as canceled.
- Added: Attendee phone numbers to the admin booking manager
- Improved: event and booking excel exporters
- Improved: Booking CSV importer
- Improved: Date display when an expired event opens directly
- Improved: Event color system and used category color as fallback color in all cases
- Improved: Admin calendar view
- Fixed: Issue in ticket selection in booking module
- Fixed: Conflict between WP Media and MEC
- Fixed: Issue regarding event gallery in Frontend Submission
- Fixed: PHP errors
- Fixed: Issues about field mapping in booking module
- Fixed: Issue about displaying ticket price label
- Fixed: Total cost display issue in MEC Cart
- Fixed: Issues in notifications
- Fixed: Integration issues in multilingual websites
- Fixed: Date filter

= 7.1.0 – 17 September 2023 =
- Added: Option to disable organizer feature
- Added: Category shortcode
- Improved: The booking edit feature
- Fixed: Issue in fee / taxes calculation
- Fixed: some issues in lite version
- Fixed: Issue in Expired Events page in backend
- Fixed: Issue regarding event repeating system
- Fixed: Couple of issues in Frontend Submission about the image upload and management
